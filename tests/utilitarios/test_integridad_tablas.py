...
Lee la cadena de conexión desde el archivo .env seguro.
"""
import pytest
import pyodbc
import os
...
# Cargar variables de entorno desde config/privado/.env
load_dotenv(os.path.join(os.path.dirname(__file__), '../config/privado/.env'))
