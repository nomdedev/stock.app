...
class ObrasController:
    ...
    def verificar_obra_en_sql_dialog_base(self):
        ...
        nombre_input.setObjectName("form_input")
        ...
        cliente_input.setObjectName("form_input")
    ...
    def agregar_obra_dialog(self, *args, **kwargs):
        ...
        try:
            ...
            apellido_input.setObjectName("form_input")
            cliente_input = QLineEdit()
            cliente_input.setObjectName("form_input")
            direccion_input = QLineEdit()
            direccion_input.setObjectName("form_input")
            telefono_input = QLineEdit()
            telefono_input.setObjectName("form_input")
            cantidad_aberturas_input = QLineEdit()
            cantidad_aberturas_input.setObjectName("form_input")
            ...
            pago_porcentaje_input.setObjectName("form_input")
            monto_usd_input = QLineEdit()
            monto_usd_input.setObjectName("form_input")
            monto_ars_input = QLineEdit()
            monto_ars_input.setObjectName("form_input")
