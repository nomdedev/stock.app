...
class HerrajesView(QWidget, TableResponsiveMixin):
    ...
    def __init__(self, db_connection=None, usuario_actual="default", controller=None):
        ...
        self.filtro_fecha_inicio.setObjectName("form_input")
        ...
        self.filtro_fecha_fin.setObjectName("form_input")
        ...
        self.filtro_busqueda.setObjectName("form_input")
    ...
    def abrir_dialogo_pedido_herrajes(self, controller=None):
        ...
        # --- Observaciones ---
        input_obs = QLineEdit()
        input_obs.setObjectName("form_input")
