...
class VidriosView(QWidget, TableResponsiveMixin):
    ...
    def create_form_layout(self):
        ...
        self.tipo_input.setObjectName("form_input")
        self.ancho_input = QLineEdit()
        self.ancho_input.setObjectName("form_input")
        self.alto_input = QLineEdit()
        self.alto_input.setObjectName("form_input")
        self.cantidad_input = QLineEdit()
        self.cantidad_input.setObjectName("form_input")
        self.proveedor_input = QLineEdit()
        self.proveedor_input.setObjectName("form_input")
    ...
    def mostrar_formulario_vidrios_obra(self):
        ...
        tipo_input.setObjectName("form_input")
